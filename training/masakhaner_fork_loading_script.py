...
_URL = "https://github.com/cdleong/masakhane-ner/raw/main/data/"
...
class Masakhaner(datasets.GeneratorBasedBuilder):
    ...
    # added the following
	#swa_no_word_boundaries
    #swa_phonemes
    #swa_phonemes_no_word_boundaries				 
    #kin_no_word_boundaries		 
    #kin_phonemes			 
	#kin_phonemes_no_word_boundaries
    BUILDER_CONFIGS = [
        ...
        MasakhanerConfig(name="swa_no_word_boundaries", version=datasets.Version("1.0.0"), description="Masakhaner Swahili dataset, with no word boundaries (character-level annotations)"),
        MasakhanerConfig(name="swa_phonemes", version=datasets.Version("1.0.0"), description="Masakhaner Swahili dataset, phonemized with epitran"),
        MasakhanerConfig(name="swa_phonemes_no_word_boundaries", version=datasets.Version("1.0.0"), description="Masakhaner Swahili dataset, phonemized with epitran,, with no word boundaries (character-level annotations)"),
        MasakhanerConfig(name="kin_no_word_boundaries", version=datasets.Version("1.0.0"), description="Masakhaner Kinyarwanda dataset, with no word boundaries (character-level annotations)"),
        MasakhanerConfig(name="kin_phonemes", version=datasets.Version("1.0.0"), description="Masakhaner Kinyarwanda dataset, phonemized with epitran"),
        MasakhanerConfig(name="kin_phonemes_no_word_boundaries", version=datasets.Version("1.0.0"), description="Masakhaner Kinyarwanda dataset, phonemized with epitran, with no word boundaries (character-level annotations)"),
    ]
